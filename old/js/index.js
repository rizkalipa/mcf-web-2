...
function finishLoad() {
  ...
  <div class="position-relative d-flex flex-column justify-content-center align-items-center"
            style="z-index: 9; min-height: inherit; overflow-y: auto;">
    <p class="h4 mt-4 text-center text-white">Pengajuan anda berhasil di submit</p>        
...
function loadSubmit(initProgress) {
  ...
  <div class="position-relative d-flex flex-column justify-content-center w-100"
            style="z-index: 9; min-height: inherit; overflow-y: auto;">
    <p class="h4 mt-4 text-center text-white">Upload your submit...</p>          
  </div>
  <div class="p-2 w-100" style="bottom: 0; position: relative; z-index: 9;">
            <div class="progress">
        ...
        $('#modal-question').fadeOut(200, 'swing', function () {
          ...
          setTimeout(function () {
            $('#modal-question').fadeOut(200, 'swing', function () {
              ...
              $('#modal-question').fadeIn(200).html(finishLoad());
            });
          }, 2000)
        });
      }
...
// $('#modal-question').click(function (e) {
//     if (e.target.classList == 'btn btn-primary') {
//         id = e.target.parentNode.parentNode.id;
//         id = id.split("-");
//         id = parseInt(id[1]);

//         document.getElementById('question-' + (id)).remove('visible');

//         document.getElementById('question-' + (id + 1)).classList.add('visible');
//     }
// });